	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Asuka-20011204",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/479044184",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/Asuka20011204",
					external: true,
					icon: "mdi:git",
				},
			],
		...
		{
      		name: "Categories", // 新增的分类导航项
      		url: "#",
      		icon: "material-symbols:category",
      		children: [], // 这里保持空，下一步通过代码动态填充
    	},
	],
};
